...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/scriptengine-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/scriptengine-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add scriptengine
# for installing globally
pixi global install scriptengine
```
...
It is possible to list all of the versions of `scriptengine` available on your platform:
...
```
pixi search scriptengine --channel conda-forge
```
